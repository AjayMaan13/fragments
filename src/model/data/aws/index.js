...
// Fragment metadata still lives in an in-memory db for now (DynamoDB comes later);
// only the fragment's raw data is stored in S3.
...
// Delete a fragment's metadata (memory db) and data (S3). Returns a Promise
